...
test("serves full-resolution photos and responsive icons without loading Turnstile globally", async () => {
  ...
  assert.ok(photoTags.length > 80);
  assert.ok(photoTags.every((tag) => !/\bsrcset=/i.test(tag) && /\?v=20260831/.test(tag)));

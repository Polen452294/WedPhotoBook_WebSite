...
function ContactsPage() {
  return (
    <section className="section"><div className="shell contact-grid">
      ...
      <div className="contact-card contact-card-wide"><div><span className="eyebrow">Мессенджеры</span><h2>Пишите там, где удобно</h2><p>Телеграм, Вотсап, Макс и ВКонтакте. Отвечаем без выходных.</p></div><div className="contact-buttons"><a href={contacts.telegram} target="_blank" rel="noreferrer">Телеграм</a><a href={contacts.whatsapp} target="_blank" rel="noreferrer">Вотсап</a><a href={contacts.max} target="_blank" rel="noreferrer">Макс</a><a href={contacts.vk} target="_blank" rel="noreferrer">ВКонтакте</a></div></div>

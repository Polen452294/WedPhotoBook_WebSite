  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid original-footer-grid">
        <div className="footer-catalog"><h2>Каталог</h2><ul><li><a href="/wedding-fotoknig/">Свадебные фотокниги</a></li><li><a href="/detskaya-fotokniga/">Детские фотокниги</a></li><li><a href="/yubilejnaya-fotokniga/">Фотокниги на юбилей</a></li><li><a href="/fotokniga-o-puteshestvii/">Фотокниги путешествий</a></li><li><a href="/vypusknye-fotoknigi/">Выпускные альбомы</a></li><li><a href="/genealogicheskaya-fotokniga/">Родословные фотокниги</a></li><li><a href="/fotokniga-na-lyubuyu-temu/">Фотокниги на любую тему</a></li><li><a href="/fotokniga-s-dopolnennoj-realnostyu/">Фотокниги с оживающими фото</a></li></ul></div>
        <div className="footer-pricing"><h2>Стоимость</h2><ul><li><a href="/fotokniga-premium/">Фотокниги Премиум</a></li><li><a href="/fotokniga-standart/">Фотокниги Стандарт</a></li><li><a href="/vypusknye-fotoknigi-stoimost/">Выпускные альбомы</a></li><li><a href="/fotoknigi-s-dopolnennoj-realnostju-stoim/">Фотокниги с оживающими фото</a></li></ul><h2 className="footer-subheading">Сервисы</h2><ul><li><a href="/company/">О компании</a></li><li><a href="/otzyvy/">Отзывы о фотокнигах</a></li><li><a href="/blog_fotoknigi/">Блог о фотокнигах</a></li><li><a href="/kontakty/">Контакты</a></li></ul></div>
        <div className="footer-agreements"><h2>Соглашения</h2><ul><li><a href="/polzovatelskoe-soglashenie/">Пользовательское соглашение</a></li><li><a href="/politika-obrabotki-personalnyh-dannyh/">Политика обработки персональных данных</a></li><li><a href="/soglashenie/">Согласие на обработку персональных данных</a></li></ul><p>ИП Ардашева Елена Викторовна<br />ИНН 772008137237 ОГРНИП 325774600377441</p></div>
        <div className="footer-contacts"><p>Телефон: <a href={contacts.phoneHref}>8 (985) 434-23-67</a></p><p>Почта:<br /><a href={`mailto:${contacts.email}`}>{contacts.email}</a></p><p>Режим работы: с 9 до 21, без выходных</p><a className="footer-max-link" href={contacts.max} aria-label="Max"><Image src="/media/social/max-wedfotobook.png" alt="" width={42} height={42} /></a></div>
      </div>
    </footer>
  );
}

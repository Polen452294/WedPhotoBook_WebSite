  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid original-footer-grid">
        ...
        <div className="footer-contacts"><div className="footer-contact-card"><p>Телефон:&nbsp; <a href={contacts.phoneHref}>8 (985) 434-23-67</a></p><p>Почта: <a href={`mailto:${contacts.email}`}>{contacts.email}</a></p><p>Режим работы: с 9 до 21, без выходных</p><p>Адрес: Москва, Свободный проспект, д. 33</p><p className="footer-socials"><a href={contacts.yandex} target="_blank" rel="noopener noreferrer"><Image src="/media/social/yandex-wedfotobook.png" alt="Фотокниги на заказ в Москве — wedfotobook" width={40} height={40} /></a><a href={contacts.vk} target="_blank" rel="noopener noreferrer"><Image src="/media/social/vk-wedfotobook.png" alt="Фотокниги на заказ в Москве — wedfotobook" width={40} height={40} /></a><a href={contacts.telegram} target="_blank" rel="noopener noreferrer"><Image src="/media/social/tg-wedfotobook.png" alt="Телеграм" width={40} height={40} /></a><a href={contacts.whatsapp} target="_blank" rel="noopener noreferrer"><Image src="/media/social/wapp-wedfotobook.png" alt="Вотсап" width={40} height={40} /></a><a href={contacts.max} target="_blank" rel="noopener noreferrer"><Image src="/media/social/max-wedfotobook.png" alt="Max" width={40} height={40} /></a></p></div></div>
      </div>
    </footer>
  );
}

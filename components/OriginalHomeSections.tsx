  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid original-footer-grid">
        ...
        <div className="footer-contacts"><div className="footer-contact-card"><p>Телефон:&nbsp; <a href={contacts.phoneHref}>8 (985) 434-23-67</a></p><p>Почта: <a href={`mailto:${contacts.email}`}>{contacts.email}</a></p><p>Режим работы: с 9 до 21, без выходных</p><p>Адрес: Москва, Свободный проспект, д. 33</p><p className="footer-socials"><a href={contacts.yandex} target="_blank" rel="noopener noreferrer"><Image src="/wp-content/uploads/2021/04/icon6-optimized.png" alt="Фотокниги на заказ в Москве — wedfotobook" width={40} height={40} /></a><a href={contacts.vk} target="_blank" rel="noopener noreferrer"><Image src="/wp-content/uploads/2021/03/icos1-optimized.png" alt="Фотокниги на заказ в Москве — wedfotobook" width={40} height={40} /></a><a href={contacts.telegram} target="_blank" rel="noopener noreferrer"><Image src="/wp-content/uploads/2021/03/icos3-optimized.png" alt="Телеграм" width={40} height={40} /></a><a href={contacts.whatsapp} target="_blank" rel="noopener noreferrer"><Image src="/wp-content/uploads/2021/03/icos5-optimized.png" alt="Вотсап" width={40} height={40} /></a><a href={contacts.max} target="_blank" rel="noopener noreferrer"><Image src="/wp-content/uploads/2026/01/logotip_max.svg_-optimized.png" alt="Max" width={40} height={40} /></a></p></div></div>
      </div>
    </footer>
  );
}

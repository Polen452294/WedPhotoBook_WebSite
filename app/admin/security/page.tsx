...
export default async function AdminSecurityPage() {
  ...
  const checks = [
    ...
    { title: "Журнал действий", text: "Хранятся хеши версий текстов и таблиц стилей, а не их содержимое и не исходные сетевые адреса. Срок хранения — 180 дней.", status: "Включено" },
  ];

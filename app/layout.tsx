...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ru"><head><link rel="stylesheet" href="/wp-assets/wordpress.css" /><link rel="stylesheet" href="/wp-assets/home-original-fix.css" /><link rel="stylesheet" href="/wp-assets/first-version-home.css" /></head><body><OrderDialog />{children}<Analytics /></body></html>;
}

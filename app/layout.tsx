...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="ru"><head><link rel="stylesheet" href="/wp-assets/wordpress.css?v=10" /><link rel="stylesheet" href="/wp-assets/home-original-fix.css?v=13" /><link rel="stylesheet" href="/wp-assets/first-version-home.css?v=28" /></head><body><OrderDialog />{children}<Analytics /></body></html>;
}
